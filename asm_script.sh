...
source="g++ main.cpp asm_alloc.cpp io.cpp translation.cpp instruction.cpp utils.cpp read_file.cpp write_file.cpp ../stack/stack_alloc.cpp ../stack/stack_funcs.cpp ../stack/stack_protection.cpp ../stack/utils.cpp -o assembler"
